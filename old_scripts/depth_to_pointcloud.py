...
import glob
import numpy as np
# import open3d as o3d => having open3d importes causes potential isssue with torch as the code stucks at depth_anything = DepthAnythingV2(**{**model_configs[args.encoder], 'max_depth': args.max_depth})
